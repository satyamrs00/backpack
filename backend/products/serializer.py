...
class ProductSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        product = Product.objects.create(
            ...
            photo1=self.context['request'].FILES[0],
            photo2=self.context['request'].FILES[1],
            photo3=self.context['request'].FILES[2],
            photo4=self.context['request'].FILES[3],
            photo5=self.context['request'].FILES[4],
