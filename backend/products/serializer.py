...
class ProductSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        product = Product.objects.create(
            ...
            photo2=self.context['request'].FILES['photo2'] or None,
            photo3=self.context['request'].FILES['photo3'] or None,
            photo4=self.context['request'].FILES['photo4'] or None,
            photo5=self.context['request'].FILES['photo5'] or None,
