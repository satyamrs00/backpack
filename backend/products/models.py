...
class Transaction(models.Model):
    ...
    fromOwner = models.ForeignKey(User, related_name='fromOwner',on_delete=models.CASCADE)
    toOwner = models.ForeignKey(User, related_name='toOwner',on_delete=models.CASCADE)
