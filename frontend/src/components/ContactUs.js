                        ...
                        <div ref={formDivRef} style={{display:'block'}}>
                            ...
                            <form onSubmit={handleSubmit} ref={formRef}>
                                <div className="mb-4 form-floating">
                                    <input  type="text" name='name' className="form-control border-0 shadow-sm" required onChange={handleOnChange} placeholder='Name' />
                                ...
                                <div className="mb-4 form-floating">
                                    <input  type="text" name='mobile' className="form-control border-0 shadow-sm" onChange={handleOnChange} placeholder='mobile' pattern='[0-9]{10}' />
                                    <label htmlFor="mobile">Mobile No.</label>
                                </div>
                                <div className="mb-4">
                                    <textarea name='message' className="form-control border-0 shadow-sm" required onChange={handleOnChange} placeholder='Message *' style={{fontSize: "calc(1rem + .1vw)", height: '8rem' }} />
                                </div>
