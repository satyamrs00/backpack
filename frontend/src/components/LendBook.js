...
export default function LendBook() {
    ...
    return (
        <>
            <div className="container" style={{ ...myStyle, padding: 'calc(1rem + .5vw)' }}>
                <div className="container" style={{ background: 'rgb(250,250,250)', padding: 'calc(1rem + 1vw)', boxShadow: "0 0 10px rgb(190, 190, 190)" }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input type="text" name='first_name' className="form-control border-0 shadow-sm py-2" onChange={handleOnChange} required />
                        </div>
                        <div className="mb-4">
                            <label htmlFor="last_name" style={{ fontSize: '1.2rem', marginBottom: ".5rem" }}>Description of book *</label>
                            <textarea type="text" name='last_name' className="form-control border-0 shadow-sm py-2" style={{ height: "7rem" }} onChange={handleOnChange} required />
                        </div>
